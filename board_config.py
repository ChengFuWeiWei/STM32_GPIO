...
class BOARD:
    """ Board initialisation/teardown and pin configuration is kept here.
        This is the STM32MP157A-DK1 board 
    """
    ...
    def setup():
        ...
        BOARD.LED = led_chip.get_line(LED_LINE_OFFSET)
        ...
        dio0_chip = gpiod.chip(DIO0_CHIP)
        BOARD.DIO0 = dio0_chip.get_line(DIO0_LINE_OFFSET)
        dio0_config = gpiod.line_request()
        '''GPIO.setup(gpio_pin, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)''' # no pull up down option
        dio0_config.request_type = gpiod.line_request.DIRECTION_INPUT
        BOARD.DIO0.request(dio0_config)
